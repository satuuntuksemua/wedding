    ...
    return (
      <Fragment>
        <div className="col-md-8 col-md-offset-4">
          <WeddingInfoBox title="Akad Nikah" time="07.00 WIB (Live di Instagram)" date=", 09 Juli 2023" />
        </div>
        <ButtonLive />
      </Fragment>
    );
            ...
            {isInvitation && (
              <div className="col-md-10 col-md-offset-1">
                <WeddingInfoBox
                  ...
                  time="Akad pada pukul 07.00 WIB dan Syukuran Sesuai jadwal undangan di e-ticket "
