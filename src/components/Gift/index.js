      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-12">
            <p>Terima kasih atas doa dan restu yang telah teman-teman berikan, jika teman-teman ingin mengirimkan kado tetapi berhalangan hadir teman-teman bisa mengirimkan di tempat resepsi pernikahan kami. Atau bisa juga dengan kirim melalui rekening di bawah ini. Sebelumnya, kami mengucapkan banyak terima kasih</p>
            <ul className="list-group mb-4">
              ...
              <div className="col lead">
              <div className="text-nowrap text-truncate" title="E-Wallet : OVO, Dana, Gopay, dan LinkAja">
              <small className="text-muted">E-Wallet : OVO, Dana, Gopay, dan LinkAja</small>
              </div>
