...
export const stories = [
  {
    ...
    description:
      'Pertama kali keduanya dipertemukan di sebuah rangkaian acara penerimaan mahasiswa baru pasca sarjana yang disebut Martikulasi di kampus Universitas Nusa Mandiri. Keduanya tidak begitu akrab hanya saling tahu nama satu sama lain saja.',
    image: img6,
  },
  {
    ...
    description:
      'Keduanya menjalani perkuliahan sebagaimana mestinya, tidak begitu akrab namun cukup sesekali menyapa. Wiwil yang cukup membaur dengan yang lain akan tetapi tidak terlalu memperhatikan sekitar jika diluar circlenya (Ary dan Ali) hihi. Latif yang cukup pendiam dan menyendiri. Si kurang peka dan si dingin tak pernah terbayang akan bersanding hihi. Sayang baru 2 semester mengenyam perkuliahan offline pandemi menyerang keduanya masih tidak saling memiliki rasa. Wiwil dengan kisah cintanya didekati beberapa pria dan latif pun dengan kisah cintanya.',
    image: img1,
  },
  {
